...
assert.ok(context.words.every(({ word, definition, synonyms }) => word && definition && synonyms), "todas as cartas devem estar completas");

const html = fs.readFileSync(new URL("../index.html", import.meta.url), "utf8");
for (const id of ["dashboardScreen", "studyScreen", "resultScreen", "rewardScreen", "pinDialog"]) {
